      ...
      child: InkWell(
        onTap: () async {
          ...
          if (_emailController.text.isNotEmpty) {
            ...
            print("===my technic=======${model!.responseCode}===============");
            ...
            Fluttertoast.showToast(
                msg: "${getTranslated(context, 'Enter valid number')}");
          }
        },
        // },
        child: SizedBox(
...
//Navigator.push(context, MaterialPageRoute(builder: (context) => SignUp(),));
        ...
        child: SizedBox(
            ...
            child: Container(
              decoration: BoxDecoration(
                  color: appColorWhite,
                  border: Border.all(color: backgroundblack, width: 2),
                  borderRadius: BorderRadius.all(Radius.circular(15))),
              height: 50.0,
              // ignore: deprecated_member_use
              child: Center(
                child: Stack(
                  children: [
                    Align(
                      alignment: Alignment.center,
                      child: Text(
                        "${getTranslated(context, 'createAnAccount')}",
                        //"Create an Account",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: backgroundblack,
  ...
  Widget _dontHaveAnAccount(BuildContext context) {
    return Text.rich(
      TextSpan(
        text: "${getTranslated(context, "don'tHaveAnAccount")}",
