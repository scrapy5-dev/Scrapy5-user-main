...
class _ManageAddressState extends State<ManageAddress> {
  ...
  Widget build(BuildContext context) {
    print("checking ids ${isSelected} and ${checkId}");
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  if (snapshot.hasData) {
                    return addModel.data?.isEmpty??true ?  Container(
                      height: MediaQuery.of(context).size.height/1,
                      child: Center(child: Text("${getTranslated(context, 'No Address Added')}",style: TextStyle(color: appColorBlack,fontSize: 16,fontWeight: FontWeight.w600),),),) : ListView.builder(
                      shrinkWrap: true,
                      physics: ClampingScrollPhysics(),
                      itemCount: addModel.data?.length??0,
                                    ...
                                    InkWell(
                                      onTap: (){
                                        setState(() {
                                          ...
                                          checkId = addModel.data?[index].id??"";
                                        });
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        TextButton.icon(
                                          ...
                                          label: Text("${getTranslated(context, 'Edit Address')}"),
  ...
  Future getAddress() async {
    ...
    if (response.statusCode == 200) {
      ...
      if(jsonResponse.responseCode == "1"){
        setState(() {
          addList = jsonResponse.data?.length??0;
          setState(() {
